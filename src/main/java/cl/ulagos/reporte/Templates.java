...
public class Templates {
	...
	static {
		...
		HyperLinkBuilder link = hyperLink("http://www.ulagos.cl");
		dynamicReportsComponent =
				cmp.horizontalList(
						cmp.image(Templates.class.getResource("images/dynamicreports.png")).setFixedDimension(60, 60),
						cmp.verticalList(
								cmp.text("Tienda Informatica ULagos").setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT),
								cmp.text("http://www.ulagos.cl").setStyle(italicStyle).setHyperLink(link))).setFixedWidth(300);
	...
	public static class CurrencyType extends IntegerType {
